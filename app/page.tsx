...
export default function Home() 
{
  ...
  return  (  
  <main className="min-h-screen bg-[30a0a0a] selection:bg-white/20">
   <section className="relative  flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
         ...
         style={{
          maskImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.5) 50%, trasnparent 100%)",
          WebkitMaskImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.5) 50%, trasnparent 100%)",
         }}
         />
         ...
         <Badge variant={'outline'} className="gap-2 p-4 backdrop-blur-sm">
          <div className="h-1.5 w-1.5 animate-pulse rounder-full bg-emerald-400"/>
          ...
          <h1 className="mx-auto max-w-3xl text-balance font-serif text-5xl leading-tight tracking-tight sm:text-5xl lg:text-7xl z-10">
            ...
            {/*Promt Box */}
            <div className="relative z-20 mx-auto mt-12 w-full max-w-2xl">
              <div
               className={cn("rounded-2xl border bg-[#111111] duration-200",
                isFocused
              ...
              >
                ...
                // className="bg-transparent text-white/40 placeholder:text-white/40 focus:outline-none"
                />
                ...
                {isSignedIn ? (
                  ...
                  <SignInButton mode="modal">
                    <Button className="h-8 rounded0full bg-white px-5 font-semibold">
                      Generate
              ...
              <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
                {SUGGESTIONS.map((s) => (
                  ...
                  className="rounded-full border-white/8 bg-white/4 px-3 py-1.5 text-xs text-white/40 hover:border-white/15 hover:bg-white/8 hover:text-white/70"
                >
                  {s}
                </button>
              ))}
    ...
    {/* ── FEATURES ──────────────────────────────────────────────────────── */}
    <section className="px-4 pb-32">
      <div className="mx-auto mb-14 max-2-5xl text-center">
