...
export const BlueTitle = ({ 
    ...
    return <p className={'bg-linear-to-br font-serif from-blue-300 via-blue-400 to-blue-600 bg-clip-text text-transparent ${className}'}>
        {children}
        </p>;
};
export const SectionLabel= ({children }:{ children: React.ReactNode}) => {
    return ( 
    <p className="inline-flex items-center gap-2 text-sm font-semibold text-blue-400 tracking-[0.14em] uppercase mb-4">
