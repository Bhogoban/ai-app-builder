...
const Header = async() => {
  ...
  return (
  <header className="w-fullfixed top-0 left-0 z-50 h-16 border-b border-white/6 bg-white/ backdrop-blur-md">
    <nav className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 xm:px-6">
        <Link href="/">
         <Image 
          src={"/logo.png"}
        alt="Forge Logo" 
